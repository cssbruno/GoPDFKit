...
func getInfoFromOpenTypeCFF(fileStr string, msgWriter io.Writer, embed bool, encList encListType) (info fontInfoType, err error) {
	var otf OpenTypeType
	otf, err = OpenTypeParse(fileStr)
	if err != nil {
		return
	}
...
func fillInfoFromTrueTypeMetrics(info *fontInfoType, ttf TtfType, msgWriter io.Writer, encList encListType) {
	otf := OpenTypeType{
...
func fillInfoFromOpenTypeMetrics(info *fontInfoType, otf OpenTypeType, msgWriter io.Writer, encList encListType) {
