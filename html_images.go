...
func htmlResolvedImageSize(info *ImageInfo, pdf *Fpdf, wd, ht float64) (float64, float64) {
	if wd == 0 && ht == 0 {
		wd = -96
		ht = -96
	}
...
func htmlImageFitBox(info *ImageInfo, pdf *Fpdf, wd, ht, boxWd, boxHt float64, fit string) (drawX, drawY, drawWd, drawHt, flowWd, flowHt float64) {
