...
// Pdf describes the document-generation methods exposed by Document.
type Pdf interface {
	...
	OutputSigned(w io.Writer, options sign.Options) error
	OutputSignedFile(fileStr string, options sign.Options) error
