...
func TestFpdfImplementPdf(t *testing.T) {
	...
	var _ gopdfkit.Pdf = (*gopdfkit.Fpdf)(nil)
	var _ gopdfkit.Pdf = (*gopdfkit.Tpl)(nil)
}

// TestPagedTemplate ensures new paged templates work
func TestPagedTemplate(t *testing.T) {
	pdf := gopdfkit.New("P", "mm", "A4", "")
	tpl := pdf.CreateTemplate(func(t *gopdfkit.Tpl) {
...
func TestIssue0193(t *testing.T) {
	...
	if err == nil {
		...
		pdf = gopdfkit.New("P", "mm", "A4", "")
		pdf.AddPage()
		_ = pdf.RegisterImageOptionsReader("sweden", gopdfkit.ImageOptions{ImageType: "png", ReadDpi: true}, rdr)
		err = pdf.Error()
	}
	if err != nil {
...
func TestPNGMalformedTransparencyDoesNotPanic(t *testing.T) {
	...
	_ = pdf.RegisterImageOptionsReader("bad-trns", gopdfkit.ImageOptions{ImageType: "png"}, bytes.NewReader(testPNG(
		3,
...
func TestPNGMalformedAlphaDataDoesNotPanic(t *testing.T) {
	...
	_ = pdf.RegisterImageOptionsReader("bad-alpha", gopdfkit.ImageOptions{ImageType: "png"}, bytes.NewReader(testPNG(
		6,
...
func TestAddFontRejectsPathTraversal(t *testing.T) {
	pdf := gopdfkit.New("P", "mm", "A4", example.FontDir())
...
func TestSVGParseCompactSignedPathValues(t *testing.T) {
	sig, err := gopdfkit.SVGParse([]byte(
...
func TestSVGParseSmoothAndArcPathCommands(t *testing.T) {
	sig, err := gopdfkit.SVGParse([]byte(`<svg width="160" height="40">
...
func TestSVGParseRejectsInvalidArcFlags(t *testing.T) {
	_, err := gopdfkit.SVGParse([]byte(`<svg width="30" height="20">
...
func TestSVGParseShapes(t *testing.T) {
	sig, err := gopdfkit.SVGParse([]byte(`<svg width="100px" height="100px">
...
func TestSVGParseUseReferencesDefinitions(t *testing.T) {
	sig, err := gopdfkit.SVGParse([]byte(`<svg width="40" height="40">
		<defs>
...
func TestSVGParseUseSymbolViewBox(t *testing.T) {
	sig, err := gopdfkit.SVGParse([]byte(`<svg width="40" height="30">
...
// application.
func Example() {
	pdf := gopdfkit.New(gopdfkit.OrientationPortrait, "mm", "A4", "")
	pdf.AddPage()
	pdf.SetFont("Arial", "B", 16)
...
func ExampleFpdf_AddPage() {
	...
	pdf.SetHeaderFuncMode(func() {
		pdf.ImageOptions(example.ImageFile("logo.png"), 10, 6, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
		pdf.SetY(5)
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_AddPage.pdf
}
...
func ExampleFpdf_MultiCell() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_MultiCell.pdf
}
...
func ExampleFpdf_SetLeftMargin() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetLeftMargin_multicolumn.pdf
}
...
func ExampleFpdf_SplitLines_tables() {
	...
	pdf := gopdfkit.New("P", "mm", "A4", "") // 210 x 297
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SplitLines_tables.pdf
}
...
func ExampleFpdf_CellFormat_tables() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_CellFormat_tables.pdf
}

// ExampleFpdf_HTMLNew demonstrates internal and external links with HTML.
func ExampleFpdf_HTMLNew() {
	pdf := gopdfkit.New("P", "mm", "A4", "")
	...
	pdf.ImageOptions(example.ImageFile("logo.png"), 10, 12, 30, 0, false, gopdfkit.ImageOptions{}, 0, "http://www.fpdf.org")
	...
	fileStr := example.Filename("Fpdf_HTMLNew")
	err := pdf.OutputFileAndClose(fileStr)
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_HTMLNew.pdf
}
...
func ExampleFpdf_AddFont() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_AddFont.pdf
}
...
func ExampleFpdf_WriteAligned() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_WriteAligned.pdf
}

// ExampleFpdf_MultiCell_textAlignments demonstrates repeated paragraph layout
// with the same fixture rendered in multiple alignments.
func ExampleFpdf_MultiCell_textAlignments() {
	fileStr := example.Filename("Fpdf_TextAlignments")
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TextAlignments.pdf
}

// ExampleFpdf_WriteLinkString_textFixture demonstrates external links described
// by a text fixture.
func ExampleFpdf_WriteLinkString_textFixture() {
	fileStr := example.Filename("Fpdf_TextInlineLinks")
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TextInlineLinks.pdf
}

// ExampleFpdf_RTL_unicodeTextFixture demonstrates UTF-8 text and explicit
// right-to-left sections from a text fixture.
func ExampleFpdf_RTL_unicodeTextFixture() {
	fileStr := example.Filename("Fpdf_TextUnicodeRTL")
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TextUnicodeRTL.pdf
}

// ExampleFpdf_SplitLines_textNotesTable demonstrates wrapped table cells from
// a pipe-delimited text fixture.
func ExampleFpdf_SplitLines_textNotesTable() {
	fileStr := example.Filename("Fpdf_TextNotesTable")
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TextNotesTable.pdf
}

// ExampleFpdf_ImageOptions_formats demonstrates how images are included in documents.
func ExampleFpdf_ImageOptions_formats() {
	pdf := gopdfkit.New("P", "mm", "A4", "")
	pdf.AddPage()
	pdf.SetFont("Arial", "", 11)
	pdf.ImageOptions(example.ImageFile("logo.png"), 10, 10, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	pdf.Text(50, 20, "logo.png")
	pdf.ImageOptions(example.ImageFile("logo.gif"), 10, 40, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	pdf.Text(50, 50, "logo.gif")
	pdf.ImageOptions(example.ImageFile("logo-gray.png"), 10, 70, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	pdf.Text(50, 80, "logo-gray.png")
	pdf.ImageOptions(example.ImageFile("logo-rgb.png"), 10, 100, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	pdf.Text(50, 110, "logo-rgb.png")
	pdf.ImageOptions(example.ImageFile("logo.jpg"), 10, 130, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	pdf.Text(50, 140, "logo.jpg")
	fileStr := example.Filename("Fpdf_ImageOptions_formats")
	err := pdf.OutputFileAndClose(fileStr)
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_ImageOptions_formats.pdf
}
...
func ExampleFpdf_ImageOptions() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_ImageOptions.pdf
}
...
func ExampleFpdf_RegisterImageOptionsReader() {
	...
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RegisterImageOptionsReader.pdf
}
...
func ExampleFpdf_SetAcceptPageBreakFunc() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetAcceptPageBreakFunc_landscape.pdf
}
...
func ExampleFpdf_SetKeywords() {
	...
	err = gopdfkit.MakeFont(example.FontFile("CalligrapherRegular.pfb"),
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetKeywords.pdf
}
...
func ExampleFpdf_Circle() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Circle_figures.pdf
}
...
func ExampleFpdf_SetAlpha() {
	...
	for range 4 {
		...
		for range 4 {
			...
			pdf.ImageOptions(example.ImageFile("golang-gopher.png"),
				x-gapX, y, rectW+2*gapX, 0, false, gopdfkit.ImageOptions{}, 0, "")
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetAlpha_transparency.pdf
}
...
func ExampleFpdf_LinearGradient() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_LinearGradient_gradient.pdf
}
...
func ExampleFpdf_ClipText() {
	...
	pdf.ImageOptions(example.ImageFile("logo.jpg"), 10, y, 32, 0, false, gopdfkit.ImageOptions{ImageType: "JPG"}, 0, "")
	pdf.ClipEnd()
	...
	pdf.ClipPolygon([]gopdfkit.Point{{X: 80, Y: y + 20}, {X: 90, Y: y},
		{X: 100, Y: y + 20}}, true)
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_ClipText.pdf
}

// ExampleFpdf_PageSize generates a PDF document with various page sizes.
func ExampleFpdf_PageSize() {
	pdf := gopdfkit.NewCustom(&gopdfkit.InitType{
		UnitStr:    "in",
		Size:       gopdfkit.Size{Wd: 6, Ht: 6},
		FontDirStr: example.FontDir(),
	})
	pdf.SetMargins(0.5, 1, 0.5)
	pdf.SetFont("Times", "", 14)
	pdf.AddPageFormat("L", gopdfkit.Size{Wd: 3, Ht: 12})
	pdf.SetXY(0.5, 1.5)
	...
	pdf.AddPageFormat("P", gopdfkit.Size{Wd: 3, Ht: 12})
	pdf.SetXY(0.5, 6)
	...
	// 2:   6.00 in,   6.00 in
	// 3:   3.00 in,  12.00 in
	// Successfully generated assets/generated/pdf/Fpdf_PageSize.pdf
}
...
func ExampleFpdf_Bookmark() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Bookmark.pdf
}
...
func ExampleFpdf_TransformBegin() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TransformBegin.pdf
}

// ExampleFpdf_RegisterImageOptions demonstrates Lawrence Kesteloot's image registration code.
func ExampleFpdf_RegisterImageOptions() {
	const (
		margin = 10
		wd     = 210
		ht     = 297
	...
	var infoPtr *gopdfkit.ImageInfo
	...
	for j, str := range fileList {
		...
		infoPtr = pdf.RegisterImageOptions(imageFileStr, gopdfkit.ImageOptions{})
		...
		pdf.ImageOptions(imageFileStr, lf, tp, imgWd, imgHt, false, gopdfkit.ImageOptions{}, 0, "")
	}
	fileStr := example.Filename("Fpdf_RegisterImageOptions")
	...
	// Successfully generated assets/generated/pdf/Fpdf_RegisterImageOptions.pdf
}
...
func ExampleFpdf_SplitLines() {
	...
	pdf := gopdfkit.New("P", "mm", "A4", "") // A4 210.0 x 297.0
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Splitlines.pdf
}

// ExampleFpdf_SVGWrite demonstrates how to render a simple SVG image with
// paths and shapes.
func ExampleFpdf_SVGWrite() {
	const (
		fontPtSize = 16.0
		wd         = 100.0
	)
	...
	fileStr := example.Filename("Fpdf_SVGWrite")
	err = pdf.OutputFileAndClose(fileStr)
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SVGWrite.pdf
}
...
func ExampleFpdf_CellFormat_align() {
	...
	var formatRect = func(pdf *gopdfkit.Fpdf, recList []recType) {
		linkStr := ""
		for range 2 {
			pdf.AddPage()
			pdf.SetMargins(10, 10, 10)
	...
	// Successfully generated assets/generated/pdf/Fpdf_CellFormat_align.pdf
}
...
func ExampleFpdf_CellFormat_codepageescape() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_CellFormat_codepageescape.pdf
}
...
func ExampleFpdf_CellFormat_codepage() {
	pdf := gopdfkit.New("P", "mm", "A4", example.FontDir()) // A4 210.0 x 297.0
	...
	pdf.AddPage()
	str := `GoPDFKit provides a translator that will convert any UTF-8 code point ` +
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_CellFormat_codepage.pdf
}

// ExampleFpdf_SetProtection demonstrates password protection for documents.
func ExampleFpdf_SetProtection() {
	pdf := gopdfkit.New("P", "mm", "A4", "")
	pdf.SetProtection(gopdfkit.CnProtectPrint, "123", "abc")
	pdf.AddPage()
	pdf.SetFont("Arial", "", 12)
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetProtection.pdf
}
...
func ExampleFpdf_Polygon() {
	...
	var rgVal int
	var pts []gopdfkit.Point
	vertices := func(count int) (res []gopdfkit.Point) {
		var pt gopdfkit.Point
		res = make([]gopdfkit.Point, 0, count)
		mlt := 2.0 * math.Pi / float64(count)
		for j := range count {
			pt.Y, pt.X = math.Sincos(float64(j) * mlt)
			res = append(res, gopdfkit.Point{
				X: x + radius*pt.X,
				Y: y + radius*pt.Y})
		}
		return
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Polygon.pdf
}
...
func ExampleFpdf_AddLayer() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_AddLayer.pdf
}

// ExampleFpdf_RegisterImageOptionsReader_flow demonstrates the use of an image
// loaded from an io.Reader in flowing page content.
func ExampleFpdf_RegisterImageOptionsReader_flow() {
	...
	if err == nil {
		...
		if pdf.Ok() {
			...
			pdf.ImageOptions(imageStr, (wd-imgWd)/2.0, pdf.GetY()+ln,
				imgWd, imgHt, false, gopdfkit.ImageOptions{ImageType: "png"}, 0, "")
		}
	} else {
		pdf.SetError(err)
	}
	fileStr := example.Filename("Fpdf_RegisterImageOptionsReader_flow")
	err = pdf.OutputFileAndClose(fileStr)
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RegisterImageOptionsReader_flow.pdf
...
func ExampleFpdf_Beziergon() {
	...
	curveList := []gopdfkit.Point{srcPrev} // point [, control 0, control 1, point]*
	control := func(x, y float64) {
		curveList = append(curveList, gopdfkit.Point{X: x, Y: y})
	}
	for j, src := range srcList {
		ctrl := ctrlList[jPrev]
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Beziergon.pdf
...
func ExampleFpdf_SetFontLoader() {
	...
	// Generalized font loader reading calligra.json
	// Generalized font loader reading calligra.z
	// Successfully generated assets/generated/pdf/Fpdf_SetFontLoader.pdf
}
...
func ExampleFpdf_MoveTo() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_MoveTo_path.pdf
}
...
func ExampleFpdf_SetLineJoinStyle() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetLineJoinStyle_caps.pdf
}
...
func ExampleFpdf_DrawPath() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_DrawPath_fill.pdf
}
...
func ExampleFpdf_CreateTemplate() {
	...
	template := pdf.CreateTemplate(func(tpl *gopdfkit.Tpl) {
		tpl.ImageOptions(example.ImageFile("logo.png"), 6, 6, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	...
	template2 := pdf.CreateTemplate(func(tpl *gopdfkit.Tpl) {
		tpl.UseTemplate(template)
		subtemplate := tpl.CreateTemplate(func(tpl2 *gopdfkit.Tpl) {
			tpl2.ImageOptions(example.ImageFile("logo.png"), 6, 86, 30, 0, false, gopdfkit.ImageOptions{}, 0, "")
	...
	template3, _ := gopdfkit.DeserializeTemplate(b)

	pdf.AddPage()
	pdf.UseTemplate(template3)
	pdf.UseTemplateScaled(template3, gopdfkit.Point{X: 0, Y: 30}, tplSize)
	pdf.Line(40, 210, 60, 210)
	pdf.Text(40, 200, "Template example page 1")

	pdf.AddPage()
	pdf.UseTemplate(template2)
	pdf.UseTemplateScaled(template3, gopdfkit.Point{X: 0, Y: 30}, tplSize.ScaleBy(1.4))
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_CreateTemplate.pdf
}
...
func ExampleFpdf_AddFontFromBytes() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_EmbeddedFont.pdf
}
...
func ExampleFpdf_ClipRect() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_ClippedTableCells.pdf
}
...
func ExampleFpdf_Rect() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_WrappedTableCells.pdf
}
...
func ExampleFpdf_SetJavascript() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetJavascript.pdf
}
...
func ExampleFpdf_AddSpotColor() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_AddSpotColor.pdf
}
...
func ExampleFpdf_RegisterAlias() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RegisterAlias.pdf
}
...
func ExampleFpdf_RegisterAlias_utf8() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RegisterAliasUTF8.pdf
}
...
func ExampleNewGrid() {
	...
	gr := gopdfkit.NewGrid(13, 10, 187, 130)
	gr.TickmarksExtentX(0, 10, 4)
	gr.TickmarksExtentY(0, 10, 3)
	gr.Grid(pdf)

	gr = gopdfkit.NewGrid(13, 154, 187, 128)
	...
	gr = gopdfkit.NewGrid(13, 10, 187, 274)
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Grid.pdf
}
...
func ExampleFpdf_SetPageBox() {
	...
	// ~ pdfinfo -box assets/generated/pdf/Fpdf_PageBox.pdf
	// Producer:       FPDF 1.7
	...
	pdf := gopdfkit.New("P", "mm", "A4", "") // 210mm x 297mm
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_PageBox.pdf
}
...
func ExampleFpdf_SubWrite() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SubWrite.pdf
}
...
func ExampleFpdf_SetPage() {
	...
	for i := range temperaturesFromSensors {
		...
		pdf.Ln(0.5)
		graph := gopdfkit.NewGrid(pdf.GetX(), pdf.GetY(), 20, 10)
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetPage.pdf
}
...
func ExampleFpdf_SetFillColor() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetFillColor.pdf
}
...
func ExampleFpdf_TransformRotate() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RotateText.pdf
}
...
func ExampleFpdf_AddUTF8Font() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_AddUTF8Font.pdf
}
...
func ExampleUTF8CutFont() {
	...
	if err == nil {
		...
		subFont = gopdfkit.UTF8CutFont(fullFont, "abcde")
	...
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_UTF8CutFont.pdf
}
...
func ExampleFpdf_RoundedRect() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_RoundedRect.pdf
}
...
func ExampleFpdf_SetUnderlineThickness() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_UnderlineThickness.pdf
}
...
func ExampleFpdf_Cell_strikeout() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_Cell_strikeout.pdf
}
...
func ExampleFpdf_SetTextRenderingMode() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_TextRenderingMode.pdf
}
...
func ExampleFpdf_SetAttachments() {
	...
	a1 := gopdfkit.Attachment{Content: file, Filename: "grid.go"}
	file, err = os.ReadFile("LICENSE")
	if err != nil {
		pdf.SetError(err)
	}
	a2 := gopdfkit.Attachment{Content: file, Filename: "License"}
	pdf.SetAttachments([]gopdfkit.Attachment{a1, a2})

	fileStr := example.Filename("Fpdf_EmbeddedFiles")
	err = pdf.OutputFileAndClose(fileStr)
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_EmbeddedFiles.pdf
}
...
func ExampleFpdf_AddAttachmentAnnotation() {
	...
	a := gopdfkit.Attachment{Content: file, Filename: "grid.go", Description: "Some amazing code !"}
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_FileAnnotations.pdf
}
...
func ExampleFpdf_SetModificationDate() {
	...
	example.Summary(err, fileStr)
	// Output:
	// Successfully generated assets/generated/pdf/Fpdf_SetModificationDate.pdf
}
