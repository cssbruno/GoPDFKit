...
func NewMeasureContext(pdf *Fpdf, width float64) MeasureContext {
	fontSize := 12.0
	lineHeight := 5.0
...
func applyPDFTextStyle(pdf *Fpdf, style TextStyle) pdfTextStyleState {
...
func restorePDFTextStyle(pdf *Fpdf, state pdfTextStyleState) {
	family := state.family
	if family == "" {
		family = "Helvetica"
	}
